...
2. **Consistency**:
   ...
   - Maintains `Data Integrity` (the process of ensuring that data is accurate, complete, consistent, and valid)
3. **Isolation**:
...
- Understand using example of transaction:
  ...
  - Consistency: Here, using consistency we are drafting the information in specific columns like name in alphabets and amounts in
